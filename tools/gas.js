...
function load(fixture, opts) {
  ...
  for (const f of ['Code.gs', 'Fixer.gs', 'Web.gs', 'Autocount.gs', 'Secrets.gs', 'PagesData.gs', 'Pages.gs', 'Run.gs', 'LiveTest.gs', 'PicFix.gs', 'Find.gs', 'Cleanup.gs', 'Repair.gs', 'Prices.gs', 'Free.gs', 'Names.gs']) {
